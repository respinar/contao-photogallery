 ...
 * @package    Photogallery
 */
class PhotogalleryAlbumModel extends \Model
{
	 ...
	 *
	 * @return \Model|null The PhotogalleryAlbumModel or null if there are no album
	 */
	...
	/**
	 * Find published album items by their parent ID
	 *
	 * @param array   $arrPids     An array of album archive IDs
	 * @param boolean $blnFeatured If true, return only featured album, if false, return only unfeatured album
	 * @param integer $intLimit    An optional limit
	 * @param integer $intOffset   An optional offset
	 * @param array   $arrOptions  An optional options array
	 *
	 * @return \Model\Collection|null A collection of models or null if there are no album
	 */
	...
	/**
	 * Count published album items by their parent ID
	 *
	 * @param array   $arrPids     An array of album archive IDs
	 * @param boolean $blnFeatured If true, return only featured album, if false, return only unfeatured album
	 * @param array   $arrOptions  An optional options array
	 *
	 * @return integer The number of album items
	 */
	...
	/**
	 * Find published album items with the default redirect target by their parent ID
	 *
	 * @param integer $intPid     The album archive ID
	 * @param array   $arrOptions An optional options array
	 *
	 * @return \Model\Collection|null A collection of models or null if there are no album
	 */
	 ...
	 * Find published album items by their parent ID
	 *
	 * @param integer $intId      The album archive ID
	 * @param integer $intLimit   An optional limit
	 * @param array   $arrOptions An optional options array
	 *
	 * @return \Model\Collection|null A collection of models or null if there are no album
	...
	/**
	 * Find all published album items of a certain period of time by their parent ID
	 *
	...
	/**
	 * Count all published album items of a certain period of time by their parent ID
	 *
	 * @param integer $intFrom    The start date as Unix timestamp
	 * @param integer $intTo      The end date as Unix timestamp
	 * @param array   $arrPids    An array of album archive IDs
